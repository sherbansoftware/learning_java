package Functional_Programming.Lambdas.Function_Object.Example;
...
public class Cache {
	/*private static final Comparator<Bookmark> RATING_COMPARATOR = new Comparator<>() {
	...
	public static void main(String[] args) {
		...
		Arrays.sort(recommendedItems.items, new Comparator<>() {
