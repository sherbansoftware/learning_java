package Functional_Programming.Functional_Interfaces.Predicate.Example;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        printEmployeesByCriteria(employees, "Employees over 180 cm", employee -> employee.getHeight() > 180);
        printEmployeesByCriteria(employees, "\nEmployees 30 and under", employee -> employee.getAge() <= 30);
...
//        }
    ...
    private static void printEmployeesByCriteria(List<Employee> employees,
                                                 String criteriaText,
                                                 Predicate<Employee> condition) {

        System.out.println(criteriaText);
        System.out.println("==================");
