package Functional_Programming.Constructor_References.Example;
...
public class FunctionalInterfaceDemo {
	...
	public static void main(String[] args) {
		...
		// Typical scenario Constructor Reference is used with Supplier
		...
		// With Consumer is useless(although compile fine )
