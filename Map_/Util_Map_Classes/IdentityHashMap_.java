 ...
 * {@link Collections#synchronizedMap Collections_.synchronizedMap}
 * method.  This is best done at creation time, to prevent accidental
 * unsynchronized access to the map:<pre>
 *   Map m = Collections_.synchronizedMap(new IdentityHashMap(...));</pre>
 *
    ...
    implements Map<K,V>, java.io.Serializable, Cloneable
{
     ...
     * corresponding mapping from the map, via the <tt>Iterator_Interface.remove</tt>,
     ...
     * the map, via the <tt>Iterator_Interface.remove</tt>, <tt>Set.remove</tt>,
