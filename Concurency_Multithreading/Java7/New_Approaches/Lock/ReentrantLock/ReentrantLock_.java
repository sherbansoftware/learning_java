package Concurency_Multithreading.Java7.New_Approaches.Lock.ReentrantLock;
...
/**
    ...
    ○  A thread invoking lock will return,
    ...
    ○ This can be checked using methods
    ...
    ○ When set true,
                      ...
                      * under contention, locks favor granting access
 ...
 * }}
    ...
    ○ In addition to implementing the  Lock interface, this class
                  ...
                  * defines a number of public and  protected methods for inspecting the state of the lock.

    ○ Some of these methods are only useful for instrumentation and monitoring.

    ○ Serialization of this class behaves in the same way as built-in locks:

                 * a deserialized lock is in the unlocked state,
 ...
 * @author Doug Lea
 */
public class ReentrantLock_ implements Lock, java.io.Serializable {
    private static final long serialVersionUID = 7373984872572414699L;
    /** Synchronizer providing all implementation mechanics */
    private final  ReentrantLock_.Sync sync;
    ...
    public ReentrantLock_() {
        sync = new  ReentrantLock_.NonfairSync();
    }
    ...
    public ReentrantLock_(boolean fair) {
        sync = fair ? new  ReentrantLock_.FairSync() : new  ReentrantLock_.NonfairSync();
    }
     ...
     *
     * <li>Some other thread plain Thread#interrupt interrupts} the
     * current thread.
     *
     * </ul>
     *
     ...
     *
     * <li>is plain Thread#interrupt interrupted} while acquiring
     * the lock,
     *
     * </ul>
     *
     ...
     * <li>The lock is acquired by the current thread; or
     *
     * <li>Some other thread plain Thread#interrupt interrupts}
     ...
     * <li>has its interrupted status set on entry to this method; or
     *
     * <li>is plain Thread#interrupt interrupted} while
     * acquiring the lock,
     *
     * </ul>
     * then  InterruptedException} is thrown and the current thread's
     ...
     * plain Condition#await() waiting} or plain
     * Condition#signal signalling} methods are called, then an
     * IllegalMonitorStateException} is thrown.
     *
     * <li>When the condition plain Condition#await() waiting}
     * methods are called the lock is released and, before they
     * return, the lock is reacquired and the lock hold count restored
     * to what it was when the method was called.
     *
     * <li>If a thread is plain Thread#interrupt interrupted}
    ...
    public final boolean isFair() {
        return sync instanceof  ReentrantLock_.FairSync;
    }
     ...
     * plain Thread#getName name} of the owning thread.
     *
     ...
     */
    static final class NonfairSync extends  ReentrantLock_.Sync {
     ...
     */
    static final class FairSync extends  ReentrantLock_.Sync {
