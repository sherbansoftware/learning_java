package Concurency_Multithreading.Synchronisation;
...
/*
    ...
    ○ The process of controlling when threads
                   ...
                   * execute code and therefore when they can access the heap is called synchronization
    ...
    1. Thread interference error
                  ...
                  * is a condition which occurs when more than one threads, executing simultaneously,

                                - access same piece of data.

    2.Memory_Address consistency error:

                 * Memory_Address consistency is

                               - more of an architecture-based concept

                               - than Java-based.

         Accesses to main memory might not occur

                 * in the same order in which the CPU initiated them
    ...
    ○ THIS is the monitor object,
      ...
      Simply put,
                  ...
                  * only one thread per monitor object

                  * can execute inside that block of code.
    ...
    ○ Every java object
                 ...
                 * and will also see this reference to as a monitor

                               - so we can synchronize block of statements that work with an object

                               - by forcing threads to acquire the objects lock before they execute the statement
    ...
    ○ We don't want threads
                ...
                * to be suspended or blocked unnecessarily

                * because that can affect the performance of an application as well as the user experience

 */

public class Synchronization_{}