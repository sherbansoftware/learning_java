...
/*                                                 Strings in Java
    ...
    ○ are Objects that are backed internally by a char array.
              ...
              <String Type> <string_variable> = "<sequence_of_string>";
    ...
    ○ If you want to store this string in the Constant Pool
      ...
      For example:
            ...
            * Always must use equal method because Java didn't always optimize memory for example in substrings case
