package lang.classes.ThreadLocal.WW_Doc;

//  https://docs.oracle.com/javase/8/docs/api/java/lang/ThreadLocal.html

class ThreadLocal_RT {
    ThreadLocal bytes;
}
...
/*               public class ThreadLocal<T> extends Object
    ...
    Each thread holds an implicit reference to its copy of a thread-local variable as long as the thread is alive and
        the ThreadLocal instance is accessible; after a thread goes away, all of its copies of thread-local instances
