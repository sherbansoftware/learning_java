...
/*                                                  Interface
    ...
    ○ So basically an interface defines

                   * what are the responsibilities for a specific class.

    ○ The best way to look at interfaces is

                   * the common actions that are supported between two classes.
