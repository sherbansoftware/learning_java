...
What is Assignment Operator, and what are Compound Assignment operators?
		...
		These operators are used compare two operands. like, if an element is equals to another or not.
		Such operators return boolean result.
...
What are logical operators?
		...
		1. Bitwise AND Operator & :
		               ...
		               * which returns bit by bit AND of input values.


		2. Bitwise OR Operator | :

		               * which returns bit by bit OR of input values.

		3. Bitwise XOR Operator ^ :

		               * which returns bit by bit XOR of input values.

		4. Bitwise Complement Operator ~ :

		               * the unary operator which returns one-s complement representation of input value.
