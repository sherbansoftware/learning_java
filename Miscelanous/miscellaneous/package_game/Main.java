package Miscelanous.miscellaneous.package_game;

import Miscelanous.InterfacesChallenge.ISavable;
import Miscelanous.InterfacesChallenge.Monster;
import Miscelanous.InterfacesChallenge.Player;
...
//        saveObject(werewolf);
        List<Miscelanous.InterfacesChallenge.ISavable> isList = Arrays.asList(new Player("Chrys", 2500, 1200), new Monster("Werewolf", 12, 36));
        for (Miscelanous.InterfacesChallenge.ISavable isS : isList) {
    ...
    public static void saveObject(Miscelanous.InterfacesChallenge.ISavable objToSave) {
