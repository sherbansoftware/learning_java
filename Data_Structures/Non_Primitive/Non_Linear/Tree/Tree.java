package Data_Structures.Non_Primitive.Non_Linear.Tree;

/*                                                   Tree

          is also one of the data structures that represent hierarchical data(or abstract data).

      Some key points of the Tree data structure:

          A tree data structure is:

              defined as a collection of objects or entities known as nodes that are linked together to represent or simulate
              hierarchy.
