...
/*                                                    Composition in Java
    ...
    ○ Composition is:
                       ...
                       * a more restricted form of Aggregation.

                   Composition can be described as when

                       * one class which includes another class, is dependent on it in such a way that it cannot
                         functionally exist without the class which is included.
        
       For example a class Car cannot exist without Engine, as it won't be functional anymore.

    ○ The Composition is a way to

                         * design or implement the "has-a" relationship.

                     Composition and Inheritance both are Design Techniques.

    ○ The Inheritance is used to implement the
