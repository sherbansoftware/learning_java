...
/*                                                        The wait() Method
    ...
    ○ Simply put, calling wait()

                  * forces the current thread to wait until some other thread
    ...
    ○ The wait() method causes the current thread
                   ...
                   * to wait indefinitely until another thread either

                                 - invokes notify() for this object
    ...
    ○ Using this method, we can specify a timeout after which a thread will be woken up automatically.
                   ...
                   * A thread can be woken up

                                  - before reaching the timeout using notify() or notifyAll().
    ...
    ○ This is yet another signature providing the same functionality.

                   * The only difference here is that we can provide higher precision.
