package Generics.Generic_Collections.Example;
...
public class GenericsExamples2 {
	...
	public static void main(String[] args) {
		...
		// Array_ method can be called with Animal[] or Dog[]
		...
		// A method declared with List<lang.classes.Object> can only be called with a List
		...
		// A method declared with List<? extends lang.classes.Object> can be called with a
		...
		// List<?> genericList = new ArrayList_<? extends Animal>(); //COMPILER ERROR
	}
