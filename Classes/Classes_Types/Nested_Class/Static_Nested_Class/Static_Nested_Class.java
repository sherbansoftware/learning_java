package Classes.Classes_Types.Nested_Class.Static_Nested_Class;
...
/*                                            Static Nested Classes
    ...
    In Java, the static keyword is primarily used for memory management.
        ...
        Using the static class is a way of grouping classes together. It is also used to access the primitive member of
           ...
           * So non-static inner classes are used when you need to group together some functionality.And you need the
                 class to have access to the instance variables of the enclosing outer class.
