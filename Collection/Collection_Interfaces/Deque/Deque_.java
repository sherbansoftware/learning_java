package Collection.Collection_Interfaces.Deque;
 ...
 Summary of Deque methods
    ...
    This interface extends the Queue interface.  When a deque is used as a queue, FIFO (First-In-First-Out) behavior results.
        ...
        Queue interface are precisely equivalent to   Deque methods as indicated in the following table:
             ...
             Queue add add(e)                                                   addLast addLast(e)


             Queue offer offer(e)                                                offerLast offerLast(e)


              Queue remove remove()                                              removeFirst removeFirst()


              Queue poll poll()                                                   pollFirst pollFirst()


               Queue  element element()                                            getFirst getFirst()


               Queue  peek peek()                                                  peekFirst peekFirst()
    ...
    Stack methods are precisely equivalent to Deque methods as indicated in the table below:
        ...
        Stack Method                                                         Equivalent  Deque Method
            ...
            * Users of any  Deque implementations that do allow null elements are strongly encouraged not to take advantage
                  of the ability to insert nulls.  This is so because null is used as a special return value by various
                  methods to indicated that the deque is empty.

           * Deque implementations generally do not define element-based versions of the  equals and  hashCode methods,
