package Collection.Concurrent_Collection_Interfaces.BlockingQueue;
...
/*                                               A blocking queue
    ...
    ○ is a queue that BLOCKS:
               ...
               A thread trying to dequeue from an empty queue is blocked until some other thread inserts an item into
                   the queue.
 ...
 * {@code BlockingQueue} methods come in four forms, with different ways  of handling operations that cannot be 
 ...
 * }}</pre>
 *
 * Memory_Address consistency effects: As with other concurrent
