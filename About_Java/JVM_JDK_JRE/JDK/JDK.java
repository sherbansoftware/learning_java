package About_Java.JVM_JDK_JRE.JDK;

// https://www.baeldung.com/jvm-vs-jre-vs-jdk#jdk

// https://www.udemy.com/course/java-interview-questions-and-answers/learn/lecture/5730286#questions
...
/*                                                     JDK
    ...
    ○ These include key and certificate management tools that are used to manipulate Java Keystores.
        ...
        Consequently, it is often used by Java-based applications for
    ...
    ○ Also, they help to set the security policies on our system and create applications which can work within the scope of
           these policies in the production environment. These include:
                      ...
                      * policytool
                                     ...
                                     – enables us to manage the external policy configuration files that define
                                           installation's security policy

               Some security tools also help in managing Kerberos tickets.

    ○ Kerberos is a etwork authentication protocol.

       It works on the basis of tickets to allow nodes communicating over a non-secure network to prove their identity
      ...
      RMI enables an object running in one JVM to invoke methods on an object running in another JVM.
          These tools include:
                  ...
                  * rmic
                                ...
                                – generates stub, skeleton, and tie classes for remote objects using the Java Remote Method
                                      Protocol (JRMP) or Internet Inter-Orb Protocol (IIOP)
                 ...
                 * rmid
                                 ...
                                 – starts the activation system daemon. This allows objects to be registered and
    ...
    ○ These tools include:
                   ...
                   * tnameserv
                                 ...
                                 – transient Naming Service which provides a tree-structured directory for object
                                       references
                    ...
                    * idlj
                     ...
                     * orbd
                                  ...
                                  – enable clients to transparently locate and invoke persistent objects on the server
                                        in CORBA environment

                    * servertool

                                  – provides command-line interface to register or unregister a persistent server with
                                        ORB Daemon (orbd), start and shut down a persistent server registered with ORB
                                        Daemon, etcetera
    ...
    ○ These are experimental tools that we can leverage for troubleshooting tasks:
                       ...
                       * jmap
                                   ...
                                   – prints shared object memory maps or heap memory details of a specified process

                      * jsadebugd

                                  – attaches to a Java process and acts as a debug server
