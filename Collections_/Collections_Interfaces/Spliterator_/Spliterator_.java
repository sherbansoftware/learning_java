 ...
 *
 */
package Collections_.Collections_Interfaces.Spliterator_;
 ...
 *
 * @apiNote
 * <p>Spliterators, like {@code Iterator_Interface}s, are for traversing the elements of
 * a source.  The {@code Spliterator} API was designed to support efficient
 * parallel traversal in addition to sequential traversal, by supporting
 * decomposition as well as single-element iteration.  In addition, the
 * protocol for accessing elements via a Spliterator is designed to impose
 * smaller per-element overhead than {@code Iterator_Interface}, and to avoid the inherent
...
public interface Spliterator_<T> {
     ...
     *
     * @apiNote Most Spliterators for Collections_, that cover all elements of a
