...
/*                                             Fail-Fast systems
    ...
    ○ The Fail Fast iterator uses

                   * an INTERNAL flag called modCount to know the status of the collection,
                         whether the collection is structurally modified or not.

                   * The modCount flag is updated each time a collection is modified;

                   * It checks the next value;

                   * if it finds, then the modCount will be modified after this iterator has been created.
