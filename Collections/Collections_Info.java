...
//  https://www.codejava.net/java-core/Collection/overview-of-java-Collection-framework-api-uml-diagram
...
/*                                              Collection
      ...
      It looks like arrays but Collection are more advanced and more flexible. An array simply stores a fixed number
          of objects, whereas a collection stores objects dynamically, i.e. you can add or remove objects as you wish.
       ...
       A collection framework is a unified architecture for representing and manipulating Collection.
       In short, Java Collection Framework is a set of reusable data structures and algorithms which are designed to free
           programmers from implementing data structures themselves so that they can focus on business logics.
       The Java Collection Framework provides common data structures implementations which are enough for general-purpose
           such as list, set, map, queue, tree, etc. These Collections are high-performance, high-quality, and easy to use
           with very good documentation.
      In addition, the Java Collection Framework provides useful and robust algorithms such as searching and sorting on
          Collection, and the interoperability between Collection and arrays.
    ...
    The Java Collection Framework is a standard API which is used extensively in Java programming. It’s the standard
        and perfect API for manipulating Collection because of the following primary benefits:
            ...
            * Reduce programming effort: with the reusable and useful data structures and algorithms, the programmers do
                  not have to re-invent the wheel, thus they can devote their time on developing application’s business.

            * Increase program speed and quality: the concrete Collection implemented by Java Collection Framework are
                  built for high performance and high quality, thus programmers can take this advantage into their programs.

            * Foster software reuse: due to the Java Collection Framework is built into the JDK, code written using
                  Collection framework can be re-used everywhere among applications, libraries and APIs. That cuts
                  development cost and increases interoperability among Java programs.
