...
/*                                        lambdas Expressions (Lambdas)
    ...
    lambda expressions are just a way of passing a block of code to a method and can only be used with interfaces that
        contain only one method that has to be implemented so these interfaces are also referred to as functional interfaces
    ...
    Functional Interface:
     ...
     Annotate your functional interfaces with @FunctionalInterface.
            ...
            * can use variable in lambda expressions if they are effectively final- it cannot be reasigned new value
