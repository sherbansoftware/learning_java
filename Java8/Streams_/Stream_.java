 ...
 * as needed.
 *
 * <p>Collections_ and streams, while bearing some superficial similarities,
 * have different goals.  Collections_ are primarily concerned with the efficient
...
public interface Stream_<T> extends BaseStream<T, Stream_<T>> {
     ...
     * such as an {@code ArrayList_}, and elements are incorporated by updating
     ...
     * For example, the following will accumulate strings into an {@code ArrayList_}:
     * <pre>{@code
     ...
     * with non-thread-safe data structures (such as {@code ArrayList_}), no
...
//    }
     ...
     * an {@code ArrayList_} as a temporary buffer.)
     *
