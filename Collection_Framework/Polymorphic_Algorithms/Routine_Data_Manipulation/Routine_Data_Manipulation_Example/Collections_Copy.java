package Collection_Framework.Polymorphic_Algorithms.Routine_Data_Manipulation.Routine_Data_Manipulation_Example;
...
public static <T> void copy(List<? super T> dest, List<? extends T> src) {
        ...
        ListIteratorDemo<? super T> di=dest.listIterator();
        ListIteratorDemo<? extends T> si=src.listIterator();
        for (int i=0; i<srcSize; i++) {
        di.next();
        di.set(si.next());
        }
