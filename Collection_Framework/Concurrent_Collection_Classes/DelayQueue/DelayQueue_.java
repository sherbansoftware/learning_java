...
package Collection_Framework.Concurrent_Collection_Classes.DelayQueue;
...
/**
    ○ An unbounded  BlockingQueue blocking queue of Delayed elements,

                  * in which an element can only be taken when its delay has expired.

    ○ The head of the queue is that Delayed element

                  * whose delay expired furthest in the past.

    ○ If no delay has expired there is no head and
    ...
    ○ Even though unexpired elements cannot be
           ...
           they are otherwise treated as normal elements.

     ○ For example, the  size method

                   * returns the count of both

                                 - expired

                                 - and unexpired elements.
...
public class DelayQueue_<E extends Delayed> extends AbstractQueue<E>
     ...
     *
     * <pre>  Delayed[] a = q.toArray(new Delayed[0]);</pre>
     *
    ...
    private class Itr implements Iterator<E> {
        final Object[] array; // Array_ of all elements
