package Collection_Framework.Concurrent_Collection_Classes.PriorityBlockingQueue;
...
public class PriorityBlockingQueue_<E> extends AbstractQueue<E>
    ...
    static {
        try {
            ...
            ALLOCATIONSPINLOCK = l.findVarHandle(java.util.concurrent.PriorityBlockingQueue.class,
                    "allocationSpinLock",
                    int.class);
    ...
    public String toString() {
        return Helpers_.collectionToString(this);
    }
    ...
    public Iterator<E> iterator() {
        return new PriorityBlockingQueue_.Itr(toArray());
    }
    ...
    public Spliterator<E> spliterator() {
        return new PriorityBlockingQueue_.PBQSpliterator();
    }
    ...
    final class PBQSpliterator implements Spliterator<E> {
        ...
        public PriorityBlockingQueue_.PBQSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid) ? null :
                    new PriorityBlockingQueue_.PBQSpliterator(array, lo, index = mid);
        }
