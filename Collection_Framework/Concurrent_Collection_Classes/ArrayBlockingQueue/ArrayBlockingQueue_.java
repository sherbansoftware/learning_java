...
package Collection_Framework.Concurrent_Collection_Classes.ArrayBlockingQueue;
...
/**
    ○ A bounded BlockingQueue blocking queue backed by an array.This queue orders elements FIFO (first-in-first-out).
   ...
   ○ This class supports an optional fairness policy for

                   * ordering waiting producer and consumer threads.
   ...
   ○ This class is a member of the Java Collections Framework
    ...
    ○ The Iterator provided in method iterator()
                  ...
                  * traverse the elements in order from first (head) to last (tail).

     ○ ArrayBlockingQueue supports an optional fairness policy

                  * for ordering waiting producer and consumer threads.

     ○ With fairness set to true, the queue grants threads access in FIFO order.
...
public class ArrayBlockingQueue_<E> extends AbstractQueue<E>
    ...
    /** The queued items */
    final Object[] items;
    /** Interface_Class lock guarding all access */
    ...
    /**
     * Iterator_Interface for ArrayBlockingQueue.
     *
     ...
     * except for the corner case of the user calling Iterator_Interface.remove()
