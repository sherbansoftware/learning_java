package Collection_Framework.Concurrent_Collection_Classes.ConcurrentLinkedDeque;
...
/**
    ...
    ○ Beware that, unlike in most collections,
     ...
     ○ Because of the  asynchronous nature of these deques,
                   ...
                   * and so may report inaccurate results

                                 - if this collection is modified during traversal.
    ...
    ○ For example, an iterator operating concurrently with an
    ...
    ○ Memory Address consistency effects:
    ...
    ○ MemoryVisibility
                  ...
                  * happen-before actions subsequent to the access or removal of that element from  the
 ...
 */
public class ConcurrentLinkedDeque_<E> extends AbstractCollection<E> implements Deque<E>, java.io.Serializable {
     ...
     *  null}.
     *
     * <p>Like the  #toArray()} method, this method acts as
     * bridge between array-based and collection-based APIs.  Further,
     * this method allows precise control over the runtime type of the
     * output array, and may, under certain circumstances, be used to
     * save allocation costs.
     *
     * <p>Suppose  x} is a deque known to contain only strings.
