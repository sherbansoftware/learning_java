package Collection_Framework.Concurrent_Collection_Classes.CopyOnWriteArraySet;
...
/**                                                       CopyOnWriteArrayList
    ...
    It is best suited for applications in which set sizes generally stay small, read-only operations vastly outnumber
        mutative operations, and you need to prevent interference among threads during traversal.
            ...
            * It is thread-safe.
            * Mutative operations  add,  set,  remove, etc. are expensive since they usually entail copying the entire
                  underlying array.
            * Iterators do not support the mutative remove operation.
            * Traversal via iterators is fast and cannot encounter interference from other threads. Iterators rely on
                  unchanging snapshots of the array at the time the iterators were constructed.

            * Sample Usage.The following code sketch uses a copy-on-write set to maintain a set of Handler objects that
...
public class CopyOnWriteArraySet_<E> extends AbstractSet<E>
     ...
     * returned by an plain Set#iterator() iterator} over the
     ...
     *
     * @param {@code o} object to be compared for equality with this set
...
//    }
     ...
     *
     * <p>The {@code Spliterator} reports  Spliterator#IMMUTABLE},
