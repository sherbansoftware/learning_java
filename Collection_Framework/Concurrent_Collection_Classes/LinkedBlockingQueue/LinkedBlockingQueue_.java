package Collection_Framework.Concurrent_Collection_Classes.LinkedBlockingQueue;
...
/**
    ...
    ○ The capacity,
                   ...
                   * if unspecified, is equal to  Integer#MAX_VALUE.

    ○ Linked nodes

                   * are dynamically created upon each insertion
...
//      */
     ...
     *
     * <p>Note that youcannot always tell if an attempt to insert
     ...
     * its elements (each an  lang.classes.Object) in the proper order,
     * followed by a null
     */
