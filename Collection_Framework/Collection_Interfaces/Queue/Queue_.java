package Collection_Framework.Collection_Interfaces.Queue;
...
/**                                                    Queue
    ...
    ○ Queues are used
                   ...
                   * in asynchronous transfer of data (where data is not being transferred at the same rate between
                         two processes) for eg.
    ...
    ○ Enqueue:
                  ...
                  * The enqueue operation is used to insert the element at the rear end of the queue.

                  * It returns void.

     ○ Dequeue:

                  * The dequeue operation performs

                                - the deletion from the front-end of the queue.

                         It also returns the element which has been removed from the front-end.

                                - It returns an integer value.

                  * The dequeue operation can also be designed to void.
     ...
     ○ Queue underflow (isempty):
                   ...
                   * When the Queue is empty, i.e., no elements are in the Queue
     ...
     ○ Linked list allocation:
                  ...
                  * The linked list allocation in a Queue
 ...
 There are four types of Queues:
    ...
    Deque
     ...
     A collection designed for holding elements prior to processing .Besides basic  Collection Collection} operations,
        queues provide additional insertion, extraction, and inspection operations.Each of these methods exists in two forms:
                ...
                * the other returns a special value (either  null} or  false},
    ...
    ○ Queues typically, but do not necessarily, order elements in a FIFO (first-in-first-out) manner.
     ...
     ○ Among the exceptions are priority queues,

                    * which order elements according to a supplied comparator,
     ...
     ○ The  offer() method inserts an element if possible, otherwise returning  false.This differs from
        the  Collection#add Collection.add() method, which can fail to add an element only by throwing an unchecked
        exception.

     ○ The offer method is designed for use when failure is a normal, rather than exceptional occurrence, for example,
     ...
     ○ The  remove() and  poll() methods remove and return the head of the queue.
         Exactly which element is removed from the queue is a function of the queue's ordering policy, which differs from
             implementation to implementation. The  remove() and  poll() methods differ only in their behavior
             when the queue is empty: the  remove() method throws an exception, while the  poll() method returns  null.
 
     ○ The  #element() and  #peek() methods return, but do not remove, the head of the queue.

     ○ The Queue interface does not define the BlockingQueue methods
        ...
        These methods,which wait for elements to appear or for space to become available,
                     ...
                     * are  defined in the java.util.concurrent.BlockingQueue interface,
    ...
    ○ Queue implementations generally do not allow insertion of null elements, although some implementations,
        such as LinkedList, do not prohibit insertion of  null.

    ○ Even in the implementations that permit it,

                      * NULL should  not be inserted into a Queue,

                      * as  null is also  used as a special return value by the poll() method
    ...
    ○ Queue implementations
       ...
       but instead inherit the identity based versions from class lang.classes.Object,
           because element-based equality

                   * is not always well-defined for queues with the same elements but different ordering properties.
