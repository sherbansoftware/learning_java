...
package Collection_Framework.Collection_Classes.Priority_Queue;

import Collection_Framework.Collection_Classes.ArrayDeque.ArrayDeque_;
...
/**                                          Priority Queue
    ...
    ○ is a special type of queue in which
   ...
   ○ The element with the highest priority is removed first.
    ...
    ○ Among these data structures,
                   ...
                   * heap data structure provides an efficient implementation of priority queues.
                                  ...
                                  Some applications of a Priority Queue are:
    ...
    ○ The head of this queue is the least element with respect to the specified ordering. If multiple elements are tied for l
        east value, the head is one of those elements -- ties are  broken arbitrarily. The queue retrieval operations  poll,
    ...
    ○ It is always
                    ...
                    * at least as large as the queue size
    ...
    ○ This class and its iterator implement all of the optional methods of the  Collection and  Iterator interfaces.
       The Iterator Interface provided in method  #iterator()
    ...
    ○ The elements of the PriorityQueue are ordered according to their natural ordering
    ...
    ○ Implementation note: this implementation provides:
                                  ...
                                  - linear time O(n) for the

                                                  • remove(lang.classes.Object)

                                                  • and  contains(lang.classes.Object)

                                  - constant time O(1) for the
...
public class PriorityQueue_<E> extends AbstractQueue<E>
     ...
     * andfail-fast  Spliterator} over the elements in this
     * queue.
     *
