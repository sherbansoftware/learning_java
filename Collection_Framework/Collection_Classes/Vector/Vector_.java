package Collection_Framework.Collection_Classes.Vector;
...
/*                                      The Vector class
    ...
    ○ implements a growable array of objects.Like an array,

                   * it contains components that can be accessed using an integer index.

    ○ However, the size of a Vector can grow or shrink as needed to accommodate adding and removing items after
    ...
    ○ legacy class
     ...
     ○ It can be considered as Legacy code.

                    * There is nothing about Vector which List collection cannot do.

                                   - Therefore  Vector should be avoided.

                     * If there is a need of thread-safe operation make ArrayList synchronized as

                      * or use CopyOnWriteArrayList which is a thread-safe variant of ArrayList.
